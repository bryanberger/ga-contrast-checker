...
gulp.task("default", function () {
  ...
  console.log('json file created at', './build/contrast.json')
  console.log('csv file created at', './build/contrast.csv')
  console.log('html file created at', './build/contrast.html')
});
